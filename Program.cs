...
namespace School
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(School.jobhunters[0].JAction1("Танненбаум Виктор Юрьевич", School.SchoolWorkers.Jobs.Assistant));
            Console.WriteLine(School.jobhunters[1].JAction1("Силенок Юрий Викторович", School.SchoolWorkers.Jobs.Senior));

            Console.WriteLine(School.teachers[0].TAction());
            Console.WriteLine(School.teachers[1].TAction());
            Console.WriteLine(" ");

            Console.WriteLine(School.jobhunters[0].JAction2("Сизов Данил Евгеньевич", 2));
            Console.WriteLine(School.students[0].SAction());
            Console.WriteLine(" ");

            Console.WriteLine(School.jobhunters[1].JAction2("Распутин Владимир Владимирович", 2));
